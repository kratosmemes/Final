...
// alert(itemId+" "+prueba);
    ...
    $.ajax({
        ...
        url: `https://waiters-browser-mx.herokuapp.com/libro/mesero/ver/${itemId}`,
        ...
        function render_items(resp){
          ...
          function addEvento(){
            ...
            $.ajax({
              ...
              url: `https://waiters-browser-mx.herokuapp.com/prestamo/mesero/${idMesero}`,
              beforeSend: function(request) {
              request.setRequestHeader("token", window.localStorage.getItem('token'));
              },
              success: function(resp) {
          ...
          function render_items(resp){
              ...
              if(status == 1){
                ...
                $.ajax({
                  ...
                  url: `https://waiters-browser-mx.herokuapp.com/libro/mesero/${idEvento}`,
                  // data: $('form').serialize(),
                  beforeSend: function(request) {
                    request.setRequestHeader("token", window.localStorage.getItem('token'));
                    },
                  ...
                  $.ajax({
                    ...
                    url: 'https://waiters-browser-mx.herokuapp.com/prestamo',
                    // data: $('form').serialize(),
                    beforeSend: function(request) {
                        request.setRequestHeader("token", window.localStorage.getItem('token'));
                        },
